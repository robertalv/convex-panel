        ...
        >
          ...
          <div className="space-y-4 mb-12">
            ...
            <p className="text-lg text-content-secondary max-w-2xl mx-auto">
              Get the full desktop experience. Debug your Convex apps with a
              native application that&apos;s always ready when you need it.
            </p>
          ...
          <div className="mt-12 text-sm text-content-tertiary space-y-2">
            <p>
              <strong className="text-content-secondary">macOS:</strong> macOS
              10.15 (Catalina) or later, Apple Silicon (M1/M2/M3)
            </p>
            <p>
