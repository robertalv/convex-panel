          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h2"
                  className="text-balance font-bold text-6xl md:text-7xl xl:text-[5.25rem]">
                  Convex Panel
                </TextEffect>
                <TextEffect
                  per="line"
                  ...
                  Convex Panel offers real-time data view, live logs, advanced filtering, health monitoring, and in-place data editing with a beautiful UI.
                </TextEffect>
            ...
            <AnimatedGroup
              ...
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                />
                <div className="relative mx-auto max-w-7xl max-h-[550px] overflow-hidden border-4">
                  <img
