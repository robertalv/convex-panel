 ...
 * Welcome Screen
 * 
 * Initial screen when user is not authenticated
...
import { APP_VERSION, GIT_COMMIT_HASH, GIT_REPO_URL } from '../../utils/version';
...
export default function WelcomeScreen() {
  ...
  const handleManualConnect = useCallback(async () => {
    // Deploy key form - to be implemented
            ...
            {GIT_COMMIT_HASH !== 'unknown' && GIT_REPO_URL && (
              <>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={[styles.commitText, { color: theme.colors.textSecondary }]}>
