/**
 * EmptyCronJobsState
 * Empty state component for cron jobs table with skeleton loader
 */
...
export function EmptyCronJobsState({ searchQuery }: EmptyCronJobsStateProps) {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      >
        {/* Header Row */}
        <div className="sticky top-0 z-10 flex items-center border-b border-border-subtle bg-surface-base p-2 text-xs font-medium text-text-muted">
          <div className="flex w-1/4 items-center">Name</div>
          <div className="flex w-1/4 items-center">Schedule</div>
          <div className="flex w-1/4 items-center">Function</div>
          <div className="flex flex-1 items-center">Last/Next Run</div>
          <div className="flex w-[100px] items-center justify-end"></div>
        </div>
          ...
          {Array.from({ length: fakeRows }).map((_, rowIdx) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col justify-center gap-0.5">
                <div
                  className="h-2.5 animate-pulse rounded-full bg-surface-hover"
                  style={{
