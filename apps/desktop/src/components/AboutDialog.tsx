...
import { ConvexLettering } from "./ui/ConvexLettering";
...
// Key repositories in the get-convex organization to check for releases
const CONVEX_REPOS = [
  "convex-backend",
  "convex-js",
  "convex-helpers",
...
export function AboutDialog({ isOpen, onClose }: AboutDialogProps) {
  ...
  const fetchLatestConvexRelease = useCallback(async () => {
    try {
      ...
      // Fetch latest releases from multiple repositories in parallel
