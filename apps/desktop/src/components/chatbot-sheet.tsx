...
import {
  navigateToDataViewWithQuery,
  getTablesForChatbot,
  navigateToLogsWithFilters,
...
import type { CustomQuery } from "@convex-panel/shared";
import {
  BarChart,
  Bar,
  LineChart,
...
const getErrorDisplayInfo = (
  ...
  if (error.isAuthError) {
    return {
      ...
      description:
        "The API key is invalid or has been revoked. Please check your AI configuration in settings.",
    ...
    <div>
      ...
      <div
        style={{
          ...
          padding: "8px 10px",
          backgroundColor:
            "color-mix(in srgb, var(--color-panel-error) 5%, var(--color-panel-bg-secondary))",
          borderRadius: "6px",
          fontSize: "11px",
...
const CodeArtifact: React.FC<{ language: string; code: string }> = ({
  language,
  code,
}) => {
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <Terminal
            size={12}
            style={{ color: "var(--color-panel-accent, #6366f1)" }}
          />
          <span
            style={{
              fontSize: "10px",
...
const FilterArtifact: React.FC<{
  data: any;
  onApply?: (data: any) => void;
  isApplying?: boolean;
}> = ({ data, onApply, isApplying }) => {
              ...
              <table className="cp-data-table">
                ...
                <tbody>
                  {rows.map((row: any, rowIdx: number) => (
                    <tr key={row?._id || rowIdx} className="cp-data-table__row">
                      {columns.map((col) => {
                        const val = row?.[col];
                          ...
                          >
                            <div className="cp-data-table__cell-content">
                              <span
                                ...
                                className="cp-data-table__cell-value"
                              >
                                {display}
                              </span>
                            </div>
                    ...
                    <tr className="cp-data-table__row">
                      ...
                      >
                        <button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.textDecoration = isApplying
                              ? "none"
                              : "underline";
                          }}
                          onMouseLeave={(e) => {
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div
            style={{
              ...
              color: isSuccess
                ? "var(--color-panel-success, #22c55e)"
                : "var(--color-panel-error, #ef4444)",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0px" }}>
            ...
            >
              {isCreateTable
                ? data.tableName || data.name || "New table"
                : isAddColumn
                  ? data.columnName || "Column"
                  : isListTables
                    ? `${data.result?.tables?.length || 0} tables`
              ...
              >
                ...
                <span
                  style={{
                    ...
                    border:
                      "1px solid color-mix(in srgb, var(--color-panel-success, #22c55e) 35%, transparent)",
                    marginLeft: "auto",
                  }}
                >
                  New Table
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            borderRadius: "8px",
                            backgroundColor:
                              "color-mix(in srgb, var(--color-panel-warning, #fbbf24) 20%, transparent)",
                            color: "var(--color-panel-warning, #fbbf24)",
                            border:
                              "1px solid color-mix(in srgb, var(--color-panel-warning, #fbbf24) 40%, transparent)",
                            marginLeft: "6px",
                          }}
                        >
              ...
              {data.result.tables.map((table: any, idx: number) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "8px 12px",
                    borderBottom:
                      idx < data.result.tables.length - 1
                        ? "1px solid var(--color-panel-border)"
                        : "none",
                  }}
                >
          ...
          {isAddColumn && (
            ...
            >
              ...
              >
                ...
                />
                <span
                  style={{ fontSize: "13px", color: "var(--color-panel-text)" }}
                >
                  {data.tableName}
                </span>
              </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div
            style={{
              ...
              borderRadius: "10px",
              backgroundColor:
                "color-mix(in srgb, var(--color-panel-accent, #6366f1) 12%, transparent)",
              color: "var(--color-panel-accent, #6366f1)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
        ...
        <div
          style={{
            ...
            backgroundColor:
              "color-mix(in srgb, var(--color-panel-success, #22c55e) 12%, transparent)",
            border:
              "1px solid color-mix(in srgb, var(--color-panel-success, #22c55e) 30%, transparent)",
            color: "var(--color-panel-success, #22c55e)",
            fontSize: "11px",
            fontWeight: 700,
          }}
              ...
              >
                ...
                <span
                  style={{
                    ...
                    color: "var(--color-panel-accent, #6366f1)",
                    backgroundColor:
                      "color-mix(in srgb, var(--color-panel-accent, #6366f1) 10%, transparent)",
                    border:
                      "1px solid color-mix(in srgb, var(--color-panel-accent, #6366f1) 30%, transparent)",
                    padding: "3px 8px",
                    borderRadius: "8px",
                    fontWeight: 700,
                    textTransform: "uppercase",
  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        border:
          "1px solid color-mix(in srgb, var(--color-panel-accent, #6366f1) 20%, transparent)",
        backgroundColor:
          "color-mix(in srgb, var(--color-panel-accent, #6366f1) 5%, transparent)",
        boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
        width: "100%",
      }}
    >
      <div
        style={{
          ...
          backgroundColor:
            "color-mix(in srgb, var(--color-panel-accent, #6366f1) 10%, transparent)",
          borderBottom:
            "1px solid color-mix(in srgb, var(--color-panel-accent, #6366f1) 10%, transparent)",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <Database
          ...
          <span
            style={{
              ...
              fontWeight: 600,
              color:
                "color-mix(in srgb, var(--color-panel-accent, #6366f1) 80%, white)",
            }}
          >
            Custom Query
          </span>
          {data.table && (
            <span
              style={{
                ...
                fontFamily: "monospace",
                color:
                  "color-mix(in srgb, var(--color-panel-accent, #6366f1) 60%, white)",
                marginLeft: "8px",
              }}
            >
              {data.table}
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor =
              "color-mix(in srgb, var(--color-panel-accent, #6366f1) 90%, black)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor =
      ...
      {data.query && (
        <div
          style={{
            ...
            backgroundColor: "var(--color-panel-bg)",
            borderTop:
              "1px solid color-mix(in srgb, var(--color-panel-border) 50%, transparent)",
          }}
        >
          <pre
            style={{
...
const LogsArtifact: React.FC<{
    ...
    if (!filters.logTypes.length && data.logs) {
      ...
      data.logs.forEach((log: any) => {
        if (log.level) {
          ...
          else if (level === "info" || level === "loginfo")
            logLevels.add("log / info");
        }
      });
  ...
  const effectiveTotalCount =
    totalCount !== undefined ? totalCount : data.logs?.length || 0;
      ...
      >
        ...
        {onViewLogs && (
          ...
          >
            {hasMore ? (
              <>
                <ArrowRight size={12} />+{remainingCount} more
              </>
            ) : (
              <>
                <Eye size={12} />
          ...
          return (
            ...
            >
              ...
              >
                {isSuccess ? (
                  <>
                    <span style={{ color: "var(--color-panel-success)" }}>
                      200
                    </span>
                    {isCached ? (
                      <span
                  ...
                  <>
                    ...
                    />
                    <span style={{ color: "var(--color-panel-error)" }}>
                      failure
                    </span>
                    {executionTime && (
                      <span style={{ color: "var(--color-panel-text-muted)" }}>
          ...
          <div>
            ...
            <div
              style={{
                ...
                fontWeight: 600,
                color:
                  (summary.overallFailureRate || 0) > 10
                    ? "var(--color-panel-error)"
                    : (summary.overallFailureRate || 0) > 5
                      ? "#fbbf24"
                      : "var(--color-panel-success)",
              }}
            >
            ...
            {topFailingFunctions.map((func: any, index: number) => {
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isHighFailure
                      ...
                      : "transparent",
                    borderBottom:
                      index < topFailingFunctions.length - 1
                        ? "1px solid color-mix(in srgb, var(--color-panel-border) 30%, transparent)"
                        : "none",
                    transition: "background-color 0.2s ease",
                    alignItems: "center",
                ...
                >
                  ...
                  >
                    {func.failures?.toLocaleString() || 0} /{" "}
                    {func.total?.toLocaleString() || 0}
                  </div>
...
const ChatInput = React.memo<ChatInputProps>(
  ({ onSubmit, isLoading, isLoadingTables, aiAvailable, checkingAi }) => {
    ...
    const isDisabled =
      isLoading || isLoadingTables || !aiAvailable || checkingAi;
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    cursor:
                      hasInput && !isLoading && !isLoadingTables
                        ? "pointer"
                        : "not-allowed",
                    backgroundColor:
                      hasInput && !isLoading && !isLoadingTables
...
export const ChatbotSheet = React.memo<ChatbotSheetProps>(
  (props) => {
    const {
      isOpen,
      onClose,
    ...
    useEffect(() => {
      ...
      if (prev.currentTable !== props.currentTable)
        changes.push("currentTable");

      prevProps.current = props;
    });

    const { theme } = useThemeSafe();
    const { refreshFilters } = useDataViewActions();
    ...
    const [messages, setMessages] = useState<Message[]>([
      {
        ...
        role: "assistant",
        content:
          "Hi! I'm your AI assistant. I can help you filter your data, answer questions, and more. Try asking me something like 'Show me all users created in the last week' or 'Filter by status active'.",
        timestamp: Date.now(),
      },
    ]);
    ...
    useEffect(() => {
      console.log(
        "[ChatbotSheet] messages changed, count:",
        messages.length,
        "last:",
    ...
    const [tableSelectorArtifact, setTableSelectorArtifact] =
      useState<TableSelectorArtifact | null>(null);
    ...
    const [selectedQuery, setSelectedQuery] = useState<CustomQuery | null>(
      null,
    );
    const [applyingFilterTarget, setApplyingFilterTarget] = useState<
      string | null
    >(null);
    const [messageMeta] = useState<
      Record<string, { model?: string; durationMs?: number }>
    >({});
    ...
    useEffect(() => {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const maxWidth = isInContainerLocal
    ...
    const addAssistantMessage = useCallback(
      async (content: string, isError: boolean = false) => {
    ...
    const applyFilterArtifact = useCallback(
      async (artifact: any) => {
        const targetTable =
          artifact?.target || artifact?.tableName || currentTable || null;

        if (!targetTable) {
          await addAssistantMessage(
            "Could not apply filters: missing table name in AI response.",
            true,
          );
          return;
        }
        ...
        try {
          ...
          await addAssistantMessage(
            error?.message ||
              "Failed to apply filters from AI result. Please try again.",
            true,
          );
        } finally {
    ...
    const startStreamPolling = useCallback(
      (chatId: string, onComplete?: () => void) => {
        ...
        console.log(
          "[ChatbotSheet] startStreamPolling called for chatId:",
          chatId,
        );
        const poll = async () => {
          ...
          try {
            ...
            const res = await listChatStreams(adminClient, {
              chatId,
            ...
            if (streams.length > 0) {
              console.log(
                "[ChatbotSheet] First stream structure:",
                JSON.stringify(streams[0]).substring(0, 500),
              );
            }
            ...
            if (existingStreamIds === null) {
              ...
              console.log(
                "[ChatbotSheet] First poll - existing streams:",
                existingStreamIds.size,
              );
            }

            // Find streams that are NEW (not in our initial set)
            const newStreams = streams.filter(
              (s: any) => !existingStreamIds!.has(s.streamId),
            );

            // Sort new streams by order to find the newest
            const sortedNewStreams = [...newStreams].sort(
            ...
            if (
              ...
              targetStream.streamId !== newStreamId
            ) {
              newStreamId = targetStream.streamId;
              console.log(
                "[ChatbotSheet] NEW stream found:",
                newStreamId,
                "order:",
                targetStream.order,
                "status:",
            ...
            const extractTextFromStream = (s: any): string => {
              ...
              return parts
                .map(
                  (c: any) =>
                    c?.text ?? c?.delta ?? c?.content ?? c?.message ?? "",
                )
                .join("");
            };

            const text = targetStream
              ? extractTextFromStream(targetStream)
              : "";

            // Check for API errors in stream parts (e.g., quota exceeded, rate limit)
            const streamParts =
              targetStream?.parts || targetStream?.chunks || [];
            const apiError = parseAPIError(streamParts);

            if (apiError) {
              console.log(
                "[ChatbotSheet] API error detected in stream:",
                apiError.code,
                apiError.message,
              );
            ...
            const isTargetFinished =
              targetStatus === "finished" || targetStatus === "aborted";
            ...
            const allFinished =
              foundNewStream && isTargetFinished && !isTargetStreaming;
            ...
            console.log(
              "[ChatbotSheet] poll result - total:",
              streams.length,
              "new:",
              newStreams.length,
              "target:",
              newStreamId?.substring(0, 8),
              "status:",
              targetStatus,
              "text:",
              text?.length || 0,
            ...
            if (shouldReload) {
              console.log(
                "[ChatbotSheet] Stopping polling, calling onComplete and loadChat",
              );
              stopStreamPolling();
              onComplete?.();
      ...
      async (query: string) => {
        ...
        if (!aiAvailable) {
          const errorMessage: Message = {
            ...
            role: "assistant",
            content:
              "AI Assistant requires an API key. Please configure it in Settings → AI Analysis.",
            timestamp: Date.now(),
            error: true,
          };
    ...
    const handleSuggestionClick = useCallback(
      (suggestion: string | { text: string; icon: any }) => {
        const text =
        ...
        {aiAvailable && sidebarOpen && (
          <>
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: "12px", color: "var(--color-panel-text)" }}
                >
                  Previous Chats
                </span>
                <div
                  ...
                  chats.map((chat) => {
                    ...
                    return (
                      <div
                        key={chat._id}
                        onClick={() =>
                          !isEditing && !isDeleting && loadChat(chat._id)
                        }
                        style={{
                          padding: "8px 12px",
                          fontSize: "12px",
          ...
          >
            ...
            {checkingAi ? (
              ...
              >
                ...
                >
                  Please configure your AI provider API key in Settings → AI
                  Analysis to use the AI Assistant.
                </div>
                <button
                  onClick={() => {
                    if (onTabChange) {
                          ...
                          ...(isError
                            ? {
                                ...
                                backgroundColor:
                                  "color-mix(in srgb, var(--color-panel-error) 10%, transparent)",
                                border:
                                  "1px solid color-mix(in srgb, var(--color-panel-error) 20%, transparent)",
                                color:
                                  "color-mix(in srgb, var(--color-panel-error) 80%, white)",
                              }
                            : {}),
                        }}
                      >
                        ...
                        {(() => {
                          if (
                            isError &&
                            message.content.startsWith('{"type":"api_error"')
                          ) {
                            try {
                              ...
                              if (
                                ...
                                return (
                                  <APIErrorArtifact error={errorData.error} />
                                );
                              }
                            } catch {
                              ...
                              components={{
                                      ...
                                      if (
                                        ...
                                        return (
                                          <FilterArtifact
                                            ...
                                            isApplying={
                                              applyingFilterTarget ===
                                              (data.target || data.tableName)
                                            }
                                          />
                                        );
                                      }
                                ...
                                blockquote: ({ node, ...props }: any) => (
                                  <blockquote
                                    style={{
                                      borderLeft:
                                        "4px solid var(--color-panel-border)",
                                      margin: "0 0 8px 0",
                                      paddingLeft: "12px",
                                      color:
                                        "var(--color-panel-text-secondary)",
                    ...
                    {SUGGESTIONS.slice(0, 3).map((suggestion, index) => {
                      const text =
                        typeof suggestion === "string"
                          ...
                          : suggestion.text;
                      const icon =
                        typeof suggestion === "object" ? suggestion.icon : null;
                      return (
                        <button
                          key={index}
                          type="button"
