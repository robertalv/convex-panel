  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 truncate rounded-full border text-sm font-medium transition-opacity hover:opacity-80 focus-visible:ring-1 focus-visible:ring-border-selected border-green-600 dark:border-green-400 bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400">
