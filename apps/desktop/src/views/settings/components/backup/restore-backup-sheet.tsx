    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "6px",
          border:
            "1px solid color-mix(in srgb, var(--color-warning-base) 20%, transparent)",
          marginBottom: "24px",
          display: "flex",
          gap: "12px",
        }}
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          >
            The tables in {deploymentName} will be replaced by the contents of
            the backup. Code, environment variables, scheduled functions, and
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: isRestoring
              ? "color-mix(in srgb, var(--color-brand-base) 50%, transparent)"
