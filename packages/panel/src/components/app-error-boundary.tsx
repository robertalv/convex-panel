...
/**
 * Error boundary that catches errors from the parent app
 * This allows ConvexPanel to remain visible even when the parent app crashes
 */
export class AppErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      // Show paused deployment error message
