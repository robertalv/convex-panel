...
export function SparklesIcon({ className, style }: { className?: string, style?: React.CSSProperties }) {
  return (
    <svg style={style} width="15" height="15" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={className}>
