...
export const ComponentDetailSheet: React.FC<ComponentDetailSheetProps> = ({
  ...
  const installCommand = component.npmPackage
    ? `npm install ${component.npmPackage}`
    : "";
  const packageUrl =
  ...
  const repoUrl =
    component.repoUrl ||
    (component.developer && component.npmPackage
      ...
      >
        ...
        >
                  ...
                  while (remaining.length > 0) {
                    ...
                    if (boldStart > 0) {
                      parts.push(
                        <span
                          key={key++}
                          style={{ color: "var(--color-panel-text-secondary)" }}
                        >
          ...
          {component.documentationSections &&
            component.documentationSections.length > 0 && (
              <>
                {component.documentationSections.map(
                              ...
                              >
                                ...
                                {subsection.code && (
                                  ...
                                  >
                                    ...
                                    <button
                                      onClick={() =>
                                        handleCopy(subsection.code!, "example")
                                      }
                                      style={{
                                        position: "absolute",
                                        top: "12px",
          ...
          {/* Example Commands */}
          {component.exampleCommands &&
            component.exampleCommands.length > 0 && (
              <div>
                <h3
                  style={{
                    fontSize: "14px",
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      handleCopy(
                        component.exampleCommands!.join("\n"),
                        "example",
                      )
                    }
                    style={{
