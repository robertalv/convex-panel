...
export const MaintainersSheet: React.FC<MaintainersSheetProps> = ({ maintainers }) => {
      ...
      >
        <div style={{ 
          ...
          <div style={{
            ...
            <span>{maintainers.length} {maintainers.length === 1 ? 'maintainer' : 'maintainers'}</span>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {maintainers.map((maintainer, idx) => {
            const maintainerAvatarUrl = maintainer.email ? avatarUrls.get(maintainer.email) : null;
